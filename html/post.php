  ...
  <body>
    <header class="header">
      <div class="header_content">
        <div class="menu_row">
          <div class="logo">
            <a href="#" title="Escape"><img src="images/logo_header.svg"  alt="Escape." width="92px" height="26px"></a>
          </div>
          <ul class="menu">
    ...
    <main>
      <div class="main_container">
        <div class="main_container_content">
          <div class="article">
            <h1 class="article_title">The Road Ahead</h1>
    ...
    <footer>
      <div class="footer_container">
        <div class="footer_content">
          <div class="menu_row">
            <div class="logo">
              <a href="#"><img src="images/logo_footer.svg"  alt="Escape." width="92px" height="26px"></a>
            </div>
            <ul class="menu">
              <li><a href="#" title="HOME">HOME</a></li>
              <li><a href="#" title="CATEGORIES">CATEGORIES</a></li>
